...
<%
String btn = String.valueOf(request.getParameter("botonCitaActaulizar")).trim(); 
        ...
        <div class="container"> 
            <div class="row col-sm-12">
                        <%
                            ...
                            vo=(CitaVO)lista1.get(0);
                       
                        %> 
                        &nbsp;
                    </div> 
            <form name="frmCitaAtualizar" id="frm1" action="../Cita/CitaActualizar.jsp" method="GET">
            <div class="panel panel-primary">
                ...
                <div class="nuevo">    
                        <div class="row form-group">
                          <input type="hidden" name="buscar" id="buscar" value="<%=vo.getCit_id()%>" size="20" maxlength="20" class="form-control input-sm" />
                        </div>                    
                        <div class="row form-group">                          
                            <label for="cit_id" class="col-sm-2 control-label">Id Cita</label>
                            <div class="col-sm-8">
                                <input type="text" name="cit_id" id="cit_id" value="<%=vo.getCit_id()%>" size="20" maxlength="20" class="form-control input-sm" />
                            </div>
                        </div>
                        <div class="row form-group">                          
                            <label for="cit_fecha_generada" class="col-sm-2 control-label">Fecha Generada</label>
                            <div class="col-sm-8">
                                <input type="date" name="cit_fecha_generada" id="cit_fecha_generada" value="<%=vo.getCit_fecha_generada()%>" size="20" maxlength="20" class="form-control input-sm" />
                            </div>
                        </div>
                         <div class="row form-group">                          
                            <label for="cit_fecha_asistencia" class="col-sm-2 control-label">Fecha de asistencia</label>
                            <div class="col-sm-8">
                                <input type="date" name="cit_fecha_asistencia" id="cit_fecha_asistencia" value="<%=vo.getCit_fecha_asistencia()%>" size="20" maxlength="20" class="form-control input-sm" />
                            </div>
                        </div>
                         <div class="row form-group">                          
                            <label for="cit_costo" class="col-sm-2 control-label">Costo</label>
                            <div class="col-sm-8">
                                <input type="text" name="cit_costo" id="cit_costo" value="<%=vo.getCit_costo()%>" size="20" maxlength="20" class="form-control input-sm" />
                            </div>
                        </div>
                         <div class="row form-group">                          
                            <label for="pac_id" class="col-sm-2 control-label">Paciente</label>
                            <div class="col-sm-8">
                                <input type="text" name="pac_id" id="pac_id" value="<%=vo.getPac().getPac_id() %>" size="20" maxlength="20" class="form-control input-sm" />
                            </div>
                        </div>
                        <div class="row form-group"> 
                       ...
                       <select name="Esp_id" id="Esp_id" class="form-control input-sm" onchange="Especialidad(document.forms['frmCitaAtualizar'])">                     
            ...
            try{
                ...
                con.listar();
                lista = con.getLista();
                out.print(EspecialidadCajaSeleccion.lista(lista, vo.getEsp_id()));
            ...
            %>
                  ...
                  <%
                    ...
                    if(lista2!=null){
                    out.print(MedxEspCajaSeleccion.lista(lista2, vo.getMed_id()));
                    }
                        }catch(Exception ex){
