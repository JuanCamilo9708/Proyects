...
public class EspecialidadCajaSeleccion {
	...
	if(lista != null){
            for(int reg = 0; reg < lista.size(); reg++ ){
                EspecialidadVO vo = (EspecialidadVO)lista.get(reg) ;
		id = new StringBuilder();
                id.append(vo.getEsp_id());
                
		str.append("<option value=\"");
		str.append(vo.getEsp_id());
		str.append("\"");
